...
import it.uniba.dib.sms222327.laureapp.ui.tesi.interfaces.FavouriteItemCallback;
...
import it.uniba.dib.sms222327.laureapp.ui.tesi.ClassificaTesiFragment;
...
public class TesiListViewHolder {
    ...
    private boolean saveListofThesis(List<String> tesiList) {
        try {
            SharedPreferences sp = context.getSharedPreferences(ClassificaTesiFragment.SHARED_PREFS_NAME, Activity.MODE_PRIVATE);
