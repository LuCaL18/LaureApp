package it.uniba.dib.sms222327.laureapp.ui.tesi;

import static android.app.Activity.RESULT_OK;
import static it.uniba.dib.sms222327.laureapp.MainActivity.REQUEST_INTERNET_PERMISSION;
import static it.uniba.dib.sms222327.laureapp.MainActivity.REQUEST_READ_EXTERNAL_STORAGE;
import static it.uniba.dib.sms222327.laureapp.ui.task.ListaTaskFragment.LIST_TASK_PERMISSION_CREATE;
import static it.uniba.dib.sms222327.laureapp.ui.task.ListaTaskFragment.LIST_TASK_TESI_KEY;
...
import it.uniba.dib.sms222327.laureapp.data.CoRelatorPermissions;
...
import it.uniba.dib.sms222327.laureapp.data.model.TesiClassifica;
import it.uniba.dib.sms222327.laureapp.data.model.Ticket;
import it.uniba.dib.sms222327.laureapp.ui.component.RequestLoginDialog;
import it.uniba.dib.sms222327.laureapp.ui.tesi.adapters.DocumentAdapter;
import it.uniba.dib.sms222327.laureapp.ui.tesi.adapters.RelatorsAdapter;
import it.uniba.dib.sms222327.laureapp.ui.tesi.dialogs.BookingDialogFragment;
import it.uniba.dib.sms222327.laureapp.ui.tesi.dialogs.CoRelatoreDialoog;
import it.uniba.dib.sms222327.laureapp.ui.tesi.dialogs.ConstraintsDialog;
import it.uniba.dib.sms222327.laureapp.ui.tesi.dialogs.QRCodeDialogFragment;
import it.uniba.dib.sms222327.laureapp.ui.tesi.dialogs.SearchKeyDialog;
import it.uniba.dib.sms222327.laureapp.ui.tesi.dialogs.UploadFileDialogFragment;
...
public class VisualizeTesiFragment extends Fragment {
    ...
    public boolean saveListofThesis(List<String> tesiList) {
        try {
            SharedPreferences sp = requireActivity().getSharedPreferences(ClassificaTesiFragment.SHARED_PREFS_NAME, Activity.MODE_PRIVATE);
            SharedPreferences.Editor mEdit1 = sp.edit();

            List<String> list = new ArrayList<>(tesiList);

            mEdit1.putString(ClassificaTesiFragment.TESI_LIST_KEY_PREF, new Gson().toJson(list));
    ...
    public ArrayList<String> getTesiList() {
        try {
            SharedPreferences sp = requireActivity().getSharedPreferences(ClassificaTesiFragment.SHARED_PREFS_NAME, Activity.MODE_PRIVATE);
            String listJson = sp.getString(ClassificaTesiFragment.TESI_LIST_KEY_PREF, null);
